...
# Match 'const translations = { ... };' up to the next '// Apply translations'
pattern = re.compile(r"const translations = \{.*?\};\n\n// Apply translations to all data-i18n elements", re.DOTALL)
...
content = pattern.sub(new_translations, content)

# 3. Modify applyTranslations function (replace translations.en -> translations.hi)
content = content.replace("translations.en", "translations.hi")
